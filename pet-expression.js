(function (root, factory) {
  ...
  const STAGE_ASSETS = Object.freeze({
    ...Object.fromEntries([...HUMAN_LINES,'penguin','turtle','frog','clownfish','salmon','hermit_crab','jellyfish','starfish','coral','butterfly','beetle','stagbeetle','cicada','antlion','dandelion'].flatMap(line => Array.from({length:8},(_,index) => {
