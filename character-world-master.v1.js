...
const NAOTOCCHI_CHARACTER_WORLD_MASTER_V1 = {
  ...
  playerSpecies: {
    normal: [
      ...
      { id: 'starfish', label: 'ヒトデ', stages: ['浮遊幼生','後期浮遊幼生','着底・変態期','変態後の稚ヒトデ','小型の稚ヒトデ','若いヒトデ','成熟したヒトデ','長生きしたヒトデ'] },
      ...
      { id: 'sakura', label: 'サクラ', stages: ['芽ぶきのサクラ','ふたばのサクラ','小さなサクラ','育ったサクラ','サクラのつぼみ','サクラの花','サクラの実','年を重ねたサクラ'] },
    ...
    rare: [
      ...
      { id: 'world_tree', label: '世界樹', stages: ['光るたね','ふしぎな苗','若い木','精霊の木','大樹','巨大な木','天にのびる木','世界樹'] },
      ...
      { id: 'unknown', label: '？？？', stages: ['点','ぷるたま','あしつきたま','ふたつぶたま','はねつきたま','おおたま','ちいさなたま','もどりの点'] },
    ],
    secret: [
