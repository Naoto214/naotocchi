...
const NAOTOCCHI_CHARACTER_WORLD_MASTER_V1 = {
  ...
  companions: {
    ...
    normal: [
      { id: 'cat_friend', label: 'きまぐれな ねこ', behavior: '自由に寝る・箱に入る', asset: 'assets/characters/companions/cat_friend.png' },
      { id: 'rabbit_friend', label: 'すばしっこい うさぎ', behavior: '急に横切る・跳ねる', asset: 'assets/characters/companions/rabbit_friend.png' },
      { id: 'tanuki', label: 'いたずら たぬき', behavior: '他の仲間にちょっかいを出す', asset: 'assets/characters/companions/tanuki.png' },
      { id: 'squirrel', label: 'おっちょこちょい リス', behavior: '木の実を運んで落とす', asset: 'assets/characters/companions/squirrel.png' },
      { id: 'owl', label: 'ものしり ふくろう', behavior: '時々豆知識を言う', asset: 'assets/characters/companions/owl.png' },
      { id: 'otter', label: 'あそびずき カワウソ', behavior: '物を転がす・滑らせる', asset: 'assets/characters/companions/otter.png' },
      { id: 'hamster', label: 'ほおぶくろ ハムスター', behavior: 'ごはんを頬に詰める', asset: 'assets/characters/companions/hamster.png' },
      { id: 'panda', label: 'ぐうたら パンダ', behavior: '食べる→寝る', asset: 'assets/characters/companions/panda.png' },
      { id: 'monkey', label: 'まねっこ サル', behavior: '主人公の動きを真似する', asset: 'assets/characters/companions/monkey.png' },
      { id: 'parrot', label: 'おしゃべり オウム', behavior: '他キャラの言葉を真似する', asset: 'assets/characters/companions/parrot.png' },
      { id: 'sheep', label: 'ふわふわ ヒツジ', behavior: '他の仲間が寄りかかる', asset: 'assets/characters/companions/sheep.png' },
      { id: 'seal', label: 'ごろごろ アザラシ', behavior: '転がって移動する', asset: 'assets/characters/companions/seal.png' },
      { id: 'bat', label: 'よふかし コウモリ', behavior: '逆さにぶら下がる', asset: 'assets/characters/companions/bat.png' },
      { id: 'chicken', label: 'はやおき ニワトリ', behavior: '朝っぽい演出で鳴く', asset: 'assets/characters/companions/chicken.png' },
      { id: 'penguin_friend', label: 'すべりたがり ペンギン', behavior: '腹ばいで滑る', asset: 'assets/characters/companions/penguin_friend.png' },
      { id: 'hedgehog', label: 'びっくり ハリネズミ', behavior: '驚くと丸くなる', asset: 'assets/characters/companions/hedgehog.png' },
      { id: 'shiba', label: 'ひとなつっこい しばいぬ', behavior: '主人公の近くを歩く', asset: 'assets/characters/companions/shiba.png' },
    ...
    rare: [
      ...
      { id: 'box', label: 'ただの はこ', asset: 'assets/characters/companions/box.png' },
    ],
  },
  ...
  partners: [
    ...
    { id: 'cliff_goat', label: 'がけの ヤギさん', firstRegion: 'mountain', hook: '毎回ありえない場所にいる', asset: 'assets/characters/partners/cliff_goat.png' },
    { id: 'high_eagle', label: 'たかねの ワシ', firstRegion: 'mountain', hook: '無口だが年月とともに心を開く', asset: 'assets/characters/partners/high_eagle.png' },
    { id: 'snow_spirit', label: 'ゆきの せいれい', firstRegion: 'snow', hook: '主人公が老いても姿が変わらない', asset: 'assets/characters/partners/snow_spirit.png' },
    { id: 'snowman', label: 'とけない ゆきだるま', firstRegion: 'snow', hook: '暖かい地域へのデートが大変', asset: 'assets/characters/partners/snowman.png' },
    { id: 'rock_octopus', label: 'いわばの タコさん', firstRegion: 'sea', hook: '8本腕の世話焼き', asset: 'assets/characters/partners/rock_octopus.png' },
    { id: 'sea_mermaid', label: 'うみの にんぎょ', firstRegion: 'sea', hook: '主人公と陸の世界を知っていく', asset: 'assets/characters/partners/sea_mermaid.png' },
    { id: 'anglerfish', label: 'ひかる チョウチンアンコウ', firstRegion: 'deepsea', hook: '暗所では積極的、明るい場所では照れる', asset: 'assets/characters/partners/anglerfish.png' },
    { id: 'swamp_croc', label: 'ぬまの ワニさん', firstRegion: 'river_lake', hook: '強面なのに照れ屋', asset: 'assets/characters/partners/swamp_croc.png' },
    { id: 'gentle_gorilla', label: 'やさしい ゴリラ', firstRegion: 'jungle', hook: '怪力なのに繊細', asset: 'assets/characters/partners/gentle_gorilla.png' },
    { id: 'knitting_spider', label: 'あみものが すきな クモさん', firstRegion: 'jungle', hook: '巣と糸でいろいろ作る', asset: 'assets/characters/partners/knitting_spider.png' },
    { id: 'desert_scorpion', label: 'さばくの サソリさん', firstRegion: 'desert', hook: '無口だが行動で優しさを示す', asset: 'assets/characters/partners/desert_scorpion.png' },
    { id: 'oasis_cactus', label: 'オアシスの サボテンさん', firstRegion: 'desert', hook: '抱きしめたいが抱きしめづらい', asset: 'assets/characters/partners/oasis_cactus.png' },
  ],
