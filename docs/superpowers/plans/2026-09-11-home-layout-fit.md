...
- The measured normal phone/tall/desktop central panels had 8px of decorative overflow after extracting narration. Their final meters' haze extended below the scroll boundary. Its bottom is now contained inside the meter block, with a browser assertion that these spacious layouts do not acquire unnecessary scrolling.
