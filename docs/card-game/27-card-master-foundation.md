...
39の登録順1〜20は全て通常・各同名3枚の個別第1稿。時・使用方法・全文は[79](79-play-batch-1-card-text-draft.md)、接続監査は[80](80-play-batch-1-text-audit.md)。残り79候補やlegacy4の希少度まで一括確定しない。既存2048の本文も保持し、登録100候補の本文ありは21枚。477候補と下記の初回311の履歴は増やさない。

## あそび第2組20枚の構築区分案（81）

39の登録順21〜40も通常・各同名3枚の個別第1稿。[81](81-play-batch-2-card-text-draft.md)に全文、[82](82-play-batch-2-text-audit.md)に40局面。79の20＋81の20＋既存2048の1で本文あり41/100、未展開59。残59やlegacy4の区分を一括確定せず、477と初回311の履歴も変更しない。

## あそび第3組20候補の構築区分案（83）

登録順41〜60を通常・各同名3枚の個別第1稿とする。新19本文と既存08の2048原文を[83](83-play-batch-3-card-text-draft.md)、40局面を[84](84-play-batch-3-text-audit.md)へ保存。2048の通常区分は今回明示し、原文と既存A/B履歴は保持。本文あり60/100・残40、登録477と初回311の履歴は不変。

## あそび第4組20候補の構築区分案（85）

登録順61〜80を通常・各同名3枚の個別第1稿とする。[85](85-play-batch-4-card-text-draft.md)に本文、[86](86-play-batch-4-text-audit.md)に40局面と前組2件の修正。本文あり80/100・未展開20。残20・legacy4・発売枚数を一括確定せず、477と初回311の履歴を維持する。

## あそび第5組20候補の構築区分案（87）

登録順81〜100を通常・各同名3枚の個別第1稿とする。[87](87-play-batch-5-card-text-draft.md)に本文、[88](88-play-batch-5-text-audit.md)に40局面。これで登録あそび100に本文・区分が接続した。新99＋既存2048の1で未展開0。一般86・地域10・季節4はsource区分で、希少度や季節の共通発動制限ではない。全100の裁定・強度・収録、legacy4の採否は未確定。登録477と初回311の履歴を維持する。
...
できごとCARD21は全て通常・各同名3枚、すぐつかうの個別第1稿。伝説5・表示名なおとは暫定できごとのまま全体の役割比較へ接続し、最終収録を確定しない。[91](91-event-21-card-text-draft.md)の本文と[92](92-event-21-text-audit.md)の監査を参照。HOLD13は本文完成枚数へ含めない。
