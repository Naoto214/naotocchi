...
現在は **全カードプールの能力本文 第1稿（Phase C）で、あそび61〜80番の20本文と追加40局面を保存した地点**。あそび本文あり80/100、未展開20。メイン248・なかま26・こいびと18・現行アイテム26の本文を維持。アイテム26は登録14＋未登録source12、旧退役24は履歴を保持。登録477へ自動加算しない。全裁定・強度は未確定、専用イラストは最後。

最新は[85 第4組20本文](85-play-batch-4-card-text-draft.md)・[86 接続監査40局面](86-play-batch-4-text-audit.md)。main `5d39eea915d09be3900d92fa879a9e9f1ecf6091`（#285）の対象61〜80を照合。通常20、すぐつかう17／しかける3、時1が12／時2が7／時3が1。段階一致・同名ペア・異種の組合せ、終了時手札と残り時による着陸を分けた。

**86 F85-01／02で前組の2件も修正。** なかま通常登場は時0、なかま・こいびと通常配置は共有1ターン1人のため、83どうぶつしょうぎの無意味な軽減を山札整理へ、パイプつなぎの成立しない両者同ターン配置条件を「両者が場にいて今ターン片方を通常配置」へ改稿。83・84を同期し、初回監査の見落としを記録した。基本ルールは維持。次は81番G-hit-blowから。
...
**次はあそび100・セカイ13・できごと34の役割地図から全件本文へ進む。** 本編アイテム改良はユーザー連絡後に76〜78へ反映済み。旧24の採否・新12の正式登録・シール商品のカード化単位は区別して整理する。相手メイン除去・ゆきだるまの捨て札行き、73 V01・75 V02は大量プロキシ前に接続する。U05の性別・恋愛対象を使わない方針、63〜65の確定事項は再質問しない。
...
2. あそびは85・86の次、39の81番G-hit-blowから未展開20枚を続ける。2048原文は08・83で保持し、84 A83-01の境界を全体監査で明文化する。その後セカイ／できごとの全件本文。73 V01・75 V02等の共通未記載事項も大量プロキシ前に解消する。
