...
現在は **全カードプールの能力本文 第1稿（Phase C）で、あそび100候補の第2組20枚を本文化し、追加40局面の接続監査を保存した地点**。あそびは79の20＋81の20＋既存2048で本文あり41/100、未展開59。メイン248・なかま26・こいびと18・現行アイテム26の保存済み本文を維持する。アイテム26は登録14＋未登録source12、旧退役source24は履歴を保持。登録済み477へ新規sourceを自動加算しない。全裁定・強度は未確定、専用イラストは最後。

最新は[81 あそび第2組20本文](81-play-batch-2-card-text-draft.md)・[82 接続監査40局面](82-play-batch-2-text-audit.md)。最新main `5d39eea915d09be3900d92fa879a9e9f1ecf6091`（#285）の対象21〜40の操作・判定を照合。精密な勝利条件、待つ探索、モード選択、装備移動、短期防衛等へ具体化した。すぐつかう17・しかける3、時1が11枚・時2が8枚・時3が1枚、通常20。次は39の41番G-animal-shogiから。旧A/Bとlegacy4は維持し、legacy4を本文41へ加算しない。
...
2. あそびは81・82の次、39の41番G-animal-shogiから未展開59枚を続ける。46番2048は既存本文を再利用し二重加算しない。その後セカイ／できごとの全件本文。73 V01・75 V02等の共通未記載事項も大量プロキシ前に解消する。
