...
現在は **[124 保存履歴からのターン終了証明と独立再開](124-turn-end-provenance-restart.md)** の保存地点。122の4停止stateから独立再開し、123の終了6手順を履歴に基づいて再証明した。各経路で次プレイヤーの卵交換まで進み、現在stateの121候補列挙で共通の空盤面family理由不足により真正停止した。
