...
現在は **[126 終了窓の訂正と現在履歴の再証明](126-current-turn-end-correction.md)** の保存地点。125の終了窓に見つかった不整合を、125原本を維持した新記録で訂正した。4経路で123の終了6手順を再証明し、R2の卵交換後の通常行動判断まで独立して進めた。R2で3経路は候補不完全、1経路は選択証明不足で真正停止した。
