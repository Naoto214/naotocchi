...
def check_checkpoint_119():
    ...
    checkpoint_119_proxy_paths = [
        ...
        if path.name not in ("test_proxy_response_window_seeded_restart.py", "test_proxy_normal_action_candidate_completeness.py", "test_proxy_normal_action_seeded_restart.py", "test_proxy_turn_end_completeness.py", "test_proxy_turn_end_provenance_restart.py", "test_proxy_normal_action_extension.py", "test_proxy_current_turn_end_correction.py", "test_proxy_r2_candidate_extension_127.py", "test_proxy_r2_candidate_extension_128.py", "test_proxy_conditional_growth_129.py", "test_proxy_board_source_world_130.py", "test_proxy_safe_placement_mixed_131.py", "test_proxy_board_active_132.py", "test_proxy_cross_restart_133.py", "test_proxy_board_response_134.py", "test_proxy_independent_seed_probe.py", "test_proxy_start_response_138.py", "test_proxy_new_seed_normal_audit_140.py", "test_proxy_new_seed_normal_restart_141.py", "test_proxy_hit_blow_response_142.py")
    ]
    proxy_count = sum(
        isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)) and
        node.name.startswith("test_")
...
proxy_test_count = sum(
    ...
    if path.name not in {"test_proxy_normal_action_candidate_completeness.py",
                          ...
                          "test_proxy_r2_candidate_extension_127.py", "test_proxy_r2_candidate_extension_128.py", "test_proxy_conditional_growth_129.py", "test_proxy_board_source_world_130.py", "test_proxy_safe_placement_mixed_131.py", "test_proxy_board_active_132.py", "test_proxy_cross_restart_133.py", "test_proxy_board_response_134.py", "test_proxy_independent_seed_probe.py", "test_proxy_start_response_138.py", "test_proxy_new_seed_normal_audit_140.py", "test_proxy_new_seed_normal_restart_141.py", "test_proxy_hit_blow_response_142.py"}
    for node in ast.walk(ast.parse(path.read_text()))
)
