...
proxy_test_count = sum(
    ...
    if path.name not in {"test_proxy_normal_action_candidate_completeness.py",
                          ...
                          "test_proxy_r2_candidate_extension_127.py", "test_proxy_r2_candidate_extension_128.py", "test_proxy_conditional_growth_129.py", "test_proxy_board_source_world_130.py", "test_proxy_safe_placement_mixed_131.py", "test_proxy_board_active_132.py", "test_proxy_cross_restart_133.py", "test_proxy_board_response_134.py"}
    for node in ast.walk(ast.parse(path.read_text()))
)
