...
> 2026-09-25更新：本書は修正前の履歴。汗と状態マークの描画順は、後続のユーザー承認により「本体→汗→状態マーク」を正式採用した。現在の決定と検証は [z-order採用QA](expression-zorder-20260925.md) を参照。犬・ウスバカゲロウ・空腹マーク等の保留は解除していない。
