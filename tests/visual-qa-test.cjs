...
console.log('VISUAL QA ROUTE TEST OK: generated script compiles; 3 delayed anniversaries; 5 pending legends; reward counts, ring and deepsea saves. No browser rendering claimed.');
