  ...
  root.installNaotocchiMeguru = function installNaotocchiMeguru(S) {
    ...
    const WORLDS = {
      ...
      sea: { len: 8000, halfW: 2500, ground: ['#f2e2b6', '#e2cf9a'], path: '#f7ecc9', props: ['🐚', '⛵', '🌴', '⛱️', '🌴', '🐚', '🌴', '⛱️'],
        zones: [Z('beach', 'すなはま', { crowd: 2.6, light: 1.05, walls: 0.45, hero: ['parasol', 300], anim: 'water', open: 1.07 }), Z('tidepools', 'しおだまりのあたり', { crowd: 2.0, tint: '#e8dcb0', walls: 0.6, hero: ['rockpool', 300], anim: 'water' }), Z('pier', 'さんばしのあたり', { crowd: 1.6, walls: 0.45, hero: ['pier', 360], anim: 'water', open: 1.04 }), Z('bay', 'いりえ', { crowd: 1.0, light: 0.98, tint: '#cfd9b0', walls: 0.85, frame: 'palmgrove', frameScale: 1.05, hero: ['driftwood', 320], field: ['🐚', '🌴', '🪵'], anim: 'water', open: 0.98, lane: ['🐚', '🌿', '🪵', '🐚'] }), Z('rocks', 'いわば', { crowd: 0.8, tint: '#c8bfa8', walls: 1.1, frame: 'searock', hero: ['bigrock', 360], field: ['🐚', '🐚', '🪸'], anim: 'water', lane: ['🐚', '🪸', '🐚', '⛱️'] }), Z('port', 'みなと', { crowd: 1.5, light: 1.0, tint: '#bfb49a', walls: 0.95, frame: 'building', frameScale: 0.9, hero: ['wreck', 380], field: ['⛵', '⚓', '🐚'], anim: 'water', open: 1.0, lane: ['⛵', '⚓', '🪵', '🐚'] }), Z('dunes', 'すなおか', { crowd: 0.5, light: 1.08, tint: '#e6d3a0', walls: 0.75, frame: 'duneridge', frameScale: 1.25, hero: ['sandcrest', 360], field: ['🌴', '🐚', '⛱️'], anim: 'sand', open: 1.1 }), Z('cape', 'みさき', { crowd: 0.6, light: 1.02, fog: 0.15, walls: 0.8, frame: 'seacliff', frameScale: 1.2, anim: 'water', open: 1.06 }), Z('seacave', 'かいしょくどうくつ', { crowd: 0.4, light: 0.72, fog: 0.28, tint: '#8f8f88', walls: 1.55, frame: 'seacliff', frameScale: 1.4, hero: ['searock', 380], field: ['🪨', '🐚', '🪨'], anim: 'water', open: 0.88, lane: ['🪨', '🐚', '💧', '🪨'] }), Z('far', 'はてのはま', { crowd: 0.35, light: 1.06, fog: 0.18, tint: '#efdcae', walls: 0.35, frameScale: 0.95, hero: ['driftwood', 340], field: ['🐚', '🪵', '🐚'], anim: 'water', open: 1.12 })],
      ...
      deepsea: { len: 7800, halfW: 2200, ground: ['#1c4166', '#102743'], path: '#1c3c5e', props: ['🪸', '🌿', '🪸', '⚓', '🐚', '🌿', '🪸', '⚓'],
        zones: [Z('shelf', 'あさせのたな', { crowd: 1.8, light: 1.1, tint: '#2e6a8f', walls: 0.5, field: ['🪸', '🐚', '🫧'], hero: ['coralfan', 310], anim: 'motes', open: 1.06 }), Z('reef', 'サンゴのまち', { crowd: 2.6, light: 1.05, field: ['🪸', '🪸', '🐚'], anim: 'motes' }), Z('kelp', 'こんぶのもり', { crowd: 1.1, light: 0.8, fog: 0.25, walls: 1.5, tint: '#1e4a4a', frame: 'kelpwall', hero: ['kelp', 340], field: ['🌿', '🌿', '🫧'], anim: 'water', open: 0.95 }), Z('wreck', 'ちんぼつせんのあたり', { crowd: 1.2, light: 0.85, walls: 1.0, tint: '#2c3f58', hero: ['wreck', 420], anim: 'glow' }), Z('glow', 'ひかるふかば', { crowd: 1.0, light: 0.9, tint: '#274f7a', walls: 0.7, hero: ['glowgarden', 320], anim: 'glow', marks: { color: '#9fe8ff', kind: 'sparkle' } }), Z('ruins', 'かいていのいせき', { crowd: 0.6, light: 0.74, fog: 0.3, tint: '#39506a', walls: 1.25, frame: 'ruinwall', frameScale: 1.2, hero: ['ruingate', 400], field: ['🏛️', '🪸', '🌿'], anim: 'motes', open: 0.94, lane: ['🏛️', '🪸', '🫧', '🌿'] }), Z('vents', 'ねっすいこう', { crowd: 0.5, light: 0.78, fog: 0.22, tint: '#4a3a48', walls: 1.0, frameScale: 1.1, hero: ['vent', 330], field: ['🫧', '🪨', '🫧'], anim: 'water', open: 1.0, marks: { color: '#c88a7a', kind: 'tuft' } }), Z('trench', 'かいこう', { crowd: 0.4, light: 0.6, fog: 0.4, tint: '#0d1c33', walls: 1.3, frameScale: 1.25, hero: ['ruinpillar', 350], anim: 'motes', open: 1.04 }), Z('abyss', 'ふかいやみ', { crowd: 0.3, light: 0.42, fog: 0.55, tint: '#060e1c', walls: 1.45, frameScale: 1.3, hero: ['glowcoral', 320], field: ['💡', '🫧', '💡'], anim: 'glow', open: 0.96, marks: { color: '#5ad8e8', kind: 'sparkle' } })],
    ...
    function buildWorld(regionId, registry, opts = {}) {
      ...
      for (const s of base.spots) {
        if (s.landmark) { world.props.push({ landmark: s.landmark, emoji: s.prop || '🌳', x: s.x, z: s.z + s.r * 0.9, size: 560, spot: true, solid: true, layer: 'landmark', label: s.label, tier: s.lmTier || 1 }); continue; }
        if (!s.prop) continue;
        ...
        if (Object.prototype.hasOwnProperty.call(SPOT_PROP_STRUCT, s.prop)) {
          ...
          world.props.push({ struct: kind, x: px0, z: pz0, size: 210, ang: 0, side: s.x < 0 ? -1 : 1, region: regionId, spot: true, solid: true, layer: 'landmark', tier: 3 });
          continue;
        }
      ...
      for (const zn of world.zones) {
        ...
        for (let k = 0; k < 24 && !placed; k++) {
          ...
          world.props.push({ struct: hk, x, z, size: hs, ang: 0, side: 1, region: regionId, layer: 'landmark', hero: true, solid: true, tier: 2 });
          placed = true;
        }
      }
    ...
    function createSimulation(init = {}) {
      ...
      const mapData = () => ({ zones: world.zones.map((z) => ({ id: z.id, label: z.label, x: z.x, z: z.z, spots: z.spots })), spots: world.spots.filter((s) => !s.secret || discovered.has(s.id)).map((s) => ({ id: s.id, label: s.label, x: s.x, z: s.z, kind: s.kind, zone: s.zone || null, secret: !!s.secret, discovered: discovered.has(s.id), current: s === curSpot })), paths: world.paths.filter(([a, b, k]) => k !== 'secret' || (discovered.has(a) && discovered.has(b))), landmarks: world.props.filter((p) => (p.landmark || p.hero) && p.tier).map((p) => ({ kind: p.landmark || p.struct, x: p.x, z: p.z, tier: p.tier, label: p.label || null })), len: world.len, halfW: world.halfW });
