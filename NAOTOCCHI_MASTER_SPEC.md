...
> **2026-09-15の優先事項:** アイテムV2の確定仕様は [最新決定](docs/superpowers/specs/2026-09-15-items-v2-design.md) を優先する。専用ごほうび・クローバー・旧スターバッジ集計・旧再会ゲームは廃止。[お楽しみ7品も全廃](docs/superpowers/specs/2026-09-15-fun-items-retirement.md)し、ホーム列・専用実績・演出を撤去、旧在庫を一度だけ返金する。この文書の過去の棚卸しに残る当該記述は旧仕様であり、復活させない。未確定の装備5品・使い切り12種の再設計は未実装。
